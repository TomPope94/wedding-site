      ...
      <main>
        ...
        <div className="pt-16 sm:pt-32 pb-64 px-4 sm:px-16 md:px-32 xl:px-64 text-black bg-white">
          ...
          <div className="mb-4 flex justify-evenly flex-wrap">
            <div className="rounded-full m-4 h-32 w-32 bg-primaryDark" />
            <div className="rounded-full m-4 h-32 w-32 bg-primaryDark" />
            <div className="rounded-full m-4 h-32 w-32 bg-primaryDark" />
            <div className="rounded-full m-4 h-32 w-32 bg-primaryDark" />
            <div className="rounded-full m-4 h-32 w-32 bg-primaryDark" />
          ...
          <p className="mb-4">
            ...
            night of our wedding. We have subsidised XX of the cost for the rooms and ask that you kindly pay the 
            remaining XX for the night. You will be staying in a 4* hotel and breakfast is included. Please bring 
