...
export default function MobileNavOverlay({
  ...
  return (
    <div
      className={`fixed inset-0 overflow-hidden bg-white z-50 transition duration-500 shadow flex flex-col justify-evenly py-16 items-center ${
        overlayActive ? "translate-x-0" : "-translate-x-[300vw]"
      }`}
    >
      <ul className="w-full overflow-auto flex flex-col justify-center items-center text-greyStandard">
